...
class ProjectedBased(ConflictDetection):
        ...
        if ownship.ntraf >= 1:
            ...
            for idx, route in enumerate(routes):
                ...
                if not self.path_plans.lineintersects[idx]:
                    ...
                    merged_line, p1 = self.build_projected_line_from_wpts(idx, route, current_loc, look_ahead_dist)
    ...
    def build_projected_line_from_wpts(self, idx, route, current_loc, look_ahead_dist):
        """
        ...
        # get all of the waypoints from route
        pass
