''' State-based conflict detection with a ProjectedBased filter. '''
import numpy as np
...
def init_plugin():
    ...
    config = {
        ...
        'plugin_name':     'PROJECTEDBASEDFILTER',
...
class ProjectedBasedFilter(ConflictDetection):
    def __init__(self):
        super().__init__()
    ...
    def detect(self, ownship, intruder, rpz, hpz, dtlookahead):
        ...
        # run projected based
        projected_based = self.detect_projectedbased(ownship, intruder, self.rpz, self.hpz, self.dtlookahead)
