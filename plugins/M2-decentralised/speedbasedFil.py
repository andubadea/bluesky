...
class SpeedBasedFil(ConflictResolution):
    def __init__(self):
        super().__init__()
    ...
    def resolve(self, conf, ownship, intruder):
        ...
        for idx1 in np.argwhere(conf.inconf).flatten():     
            ...
            gs_new, alt_new, track_new = self.SpeedBasedFil(conf, ownship, intruder, idx1, idx_pairs)
    ...
    def SpeedBasedFil(self, conf, ownship, intruder, idx1, idx_pairs):
    ...
    def check_speed(self, conf, ownship, intruder, idx1, speed):
        ...
        for idx2 in idx_others:
            ...
            if (priority_ok and not in_front) or (in_back):
                continue
            VelocityObstacles.append(self.get_VO(conf, ownship, intruder, idx1, idx2, -1))
        if los:
            return False
    ...
    def get_VO(self, conf, ownship, intruder, idx1, idx2, idx_pair = -1):
